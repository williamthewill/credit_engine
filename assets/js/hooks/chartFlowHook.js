const chartFlowHook = {
  mounted() {
    ...
    editor.start();
    this.pushEvent("get_data_to_import", {}, ({ data_to_import }) => {
      editor.import(data_to_import);
    });

    this.pushEvent("api_driven", {}, ({ data }) => {
    ...
    saveData = () => {
      ...
      this.pushEvent("save_data", { data_to_save }, ({ was_saved }) => {
    ...
    function addNodeToDrawFlow(name, pos_x, pos_y) {
      ...
      switch (name) {
        ...
        case 'apidrivendados':
          ...
          select.setAttribute('id', 'proList');
...
export default chartFlowHook

// curl --request GET --url http://localhost:4000/api/user